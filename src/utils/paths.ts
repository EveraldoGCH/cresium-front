export const paths = {
  ...
  dashboard: {
    overview: "/dashboard",
    transactions: "/dashboard/transacciones",
    payments: "/dashboard/pagos",
    accounts: "/dashboard/cuentas",
    account: "/dashboard/cuenta",
    ...
    chat: {
      ...
      thread: (threadType: string, threadId: string) =>
    ...
    jobs: {
      ...
      companies: {
        overview: (companyId: string) =>
          `/dashboard/jobs/companies/${companyId}`,
        ...
        team: (companyId: string) =>
          `/dashboard/jobs/companies/${companyId}/team`,
        assets: (companyId: string) =>
          `/dashboard/jobs/companies/${companyId}/assets`,
      },
    },
    logistics: {
    ...
    mail: {
      ...
      details: (label: string, emailId: string) =>
        `/dashboard/mail/${label}/${emailId}`,
    },
    orders: {
    ...
    products: {
      ...
      preview: (productId: string) =>
        `/dashboard/products?previewId=${productId}`,
