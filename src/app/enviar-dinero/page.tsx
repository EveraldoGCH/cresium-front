...
export default function EnviarDinero() {
  ...
  const breadcrumbs = [
    ...
    <Typography key="3">Enviar dinero</Typography>,
  ];
  ...
  return (
    <Stack spacing={4} sx={{ width: "100%" }}>
      ...
      >
        <Box sx={{ flex: "1 1 auto" }}>
          ...
          <Typography variant="body1" color={colorsVars.grey500}>
            Envia dinero de tu cuenta a una persona o empresa
          </Typography>
        </Box>
        <Box
          sx={{
        ...
        >
          <Typography variant="body1" fontWeight={500}>
            ¿Queres enviar dinero a múltiples cuentas?
          </Typography>
          <Button
            variant="text"
            sx={{ padding: 0, boxShadow: "none", marginRight: "8px" }}
          >
            Pagos masivos
          </Button>
        </Box>
      ...
      <Divider />
      <Stack sx={{ width: "100%", alignItems: "flex-end" }} spacing={4}>
        {/*Contenedor Card */}
        <Grid
          container
          xs={12}
            ...
            <Stack gap={"16px"} style={{ width: "100%" }}>
              ...
              <Card style={{ padding: "24px" }}>
                <Grid container xs={12} gap={"16px"}>
                  <Typography variant="subtitle1">Cuenta de origen</Typography>
                  <Card
                    style={{
                ...
                {step === 1 && (
                  <Box display={"flex"} flexDirection={"column"} gap={"16px"}>
                    ...
                    >
                      ...
                      >
                        {" "}
                        términos de uso y privacidad de Cresium.
                      </p>
                    </Typography>
                  </Box>
                )}
