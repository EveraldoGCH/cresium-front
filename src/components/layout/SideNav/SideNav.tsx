...
// import type { any } from '@/types/nav';
    ...
    >
      <Stack spacing={2} sx={{ p: 2 }}>
        <div>
          ...
          >
            <Logo color={undefined} height={32} width={122} />
          </Box>
        </div>
      </Stack>
      <Box
      ...
      >
        {renderNavGroups({ items: secondaryItems, pathname })}
      </Box>
    </Box>
  );
}
          ...
          {/* {iconPath ? (
            <img
              ...
              style={{
                ...
                ...(forceOpen || active ? { fontWeight: 'fill' } : {}),
              }}
            />
          ) : null} */}
        </Box>
